              ...
              <div className="flex items-center justify-between p-2">
                ...
                <div className="flex flex-col items-center gap-3 text-center">
                  ...
                  <p className="font-manrope w-[70%] text-sm">
                    The Luna wolf is the leader of the group, responsible for
                    protecting the pack, dealing with threats to the pack’s
                    survival, making decisions, and leading hunts.
                  </p>
                </div>
                <span>
                  <svg
