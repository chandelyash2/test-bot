      ...
      <div className="absolute bottom-0 z-10 min-h-[300px] w-full left-0 bg-[#1C2327] flex flex-col items-center border-t border-[#54C7EE] rounded-t p-2 gap-6">
        ...
        <span>
          ...
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_4569_1822)">
              <path
                d="M54.0055 57.6905L66.3394 48.5725L100.952 74.9098L71.8372 31.1773H62.4582L54.1737 18.7332L35.6459 46.5634L54.0055 57.6905Z"
                fill="white"
              />
              <path
                d="M25.5831 47.5902L0.5 85.2668H62.0928L51.8099 63.4855L25.5831 47.5902Z"
                fill="url(#paint0_linear_4569_1822)"
              />
              <path
                d="M66.2867 56.1898L57.9973 62.3178L68.8315 85.2668H104.5L66.2867 56.1898Z"
                fill="url(#paint1_linear_4569_1822)"
              />
            </g>
            <defs>
              <linearGradient
                id="paint0_linear_4569_1822"
                x1="31.2964"
                y1="47.5902"
                x2="31.2964"
                y2="85.2668"
        ...
        <div className="flex gap-1 items-center">
          ...
          <h3 className="text-lg font-roboto font-bold">825k</h3>
        </div>
        <h2 className="text-xs font-bold font-roboto">
          Alpha Ranking
          <span className="text-[10px] text-gray-300 pl-1">Required</span>
        </h2>
        <Button className="bg-[#00ACE6] rounded p-4 w-full text-white mb-4">
          Buy Card
        </Button>
      </div>
    </div>
